...
public:
    ...
    void loadGrain(const Properties &props, ref<FileResolver> &fileResolver) {
    ...
    GrainMesh(const Properties &props) : Shape(props) {
        ...
        */
        ...
        for(size_t i=0; i<m_meshes.size(); i++)
        {
            ...
            const Triangle* triangles = (m_meshes.at(i))->getTriangles();
            Point* positions = m_meshes.at(i)->getVertexPositions();

            for(size_t j=0; j<count; j++) {
                allKDTriangles.push_back(
